...
import space.kosmonaffft.dbrestr.metadata.SchemaMetadata
import space.kosmonaffft.dbrestr.metadata.TableMetadata
    ...
    private fun generateTableMetadata(connection: Connection, schemaName: String, tableName: String, tableComment: String?): TableMetadata {
        ...
        connection.metaData.getColumns(null, schemaName, tableName, null).use { columnsResultSet ->
            while (columnsResultSet.next()) {
                ...
                val sqlType = columnsResultSet.getInt("DATA_TYPE")
                ...
                val columnMetadata = ColumnMetadata(columnName, columnType, sqlType, columnNullable, autoIncremented, comment)
